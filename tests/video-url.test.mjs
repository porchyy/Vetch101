...
test("reject concatenated links without rejecting a URL in query parameters", () => {
  ...
  assert.throws(() => parseVideoUrl("https://www.w3schools.com/html/mov_" + tiktok), /ซ้อนกัน/);
  assert.throws(() => parseVideoUrl("https://www.youtube.com/watch?v=123https://www.youtube.com/watch?v=456"), /ซ้อนกัน/);
